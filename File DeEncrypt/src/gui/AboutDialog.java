...
public class AboutDialog extends JDialog {
	...
	private void initialize() {
		...
		this.setTitle("About File DeEncryption");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			labelIcon.setText("");
			labelIcon.setPreferredSize(new Dimension(81, 64));
			labelIcon.setIcon(new ImageIcon(getClass().getResource("/resource/lock64.png")));
			...
			jContentPane.add(labelIcon, gridBagConstraints11);
		}
		return jContentPane;
	}
	...
	private JTextArea getTextAreaDesc() {
		if (textAreaDesc == null) {
			...
			textAreaDesc.setText("File DeEncryption\n\nDeveloped by: David Cui\n\nSeptember 2011");
